...
const STORE_KEY = "dsa-cpp-roadmap-progress";
  ...
  return (
    <header>
      <div className="inline-block rotate-[-2deg] border-4 border-black bg-[#ffd93d] px-4 py-1 shadow-[4px_4px_0_0_#fff] hover:-translate-y-1 transition-transform">
        <span className="text-sm font-black uppercase tracking-widest text-black">30-Day Roadmap</span>
      </div>
      <h1 className="mt-6 text-5xl font-black leading-none tracking-tight sm:text-7xl">
        C++ &amp; DSA
        <br />
        Zero → Interview-Ready.
      </h1>
      <p className="mt-4 max-w-xl text-lg font-bold sm:text-xl">
        Master Data Structures and Algorithms in C++. Tick a day when you finish it.
      </p>

      {/* Global Progress Bar */}
      <div className="mt-10 border-4 border-black bg-white text-black p-5 shadow-[8px_8px_0_0_#14110d] dark:shadow-[8px_8px_0_0_rgba(255,255,255,0.2)] sticky top-4 z-40">
  ...
  return (
    <section className="scroll-mt-24">
      ...
      <div
        ...
        className={`cursor-pointer flex flex-wrap items-center gap-4 border-4 border-black p-4 transition-all active:translate-y-1 active:shadow-none shadow-[4px_4px_0_0_#14110d] hover:shadow-[6px_6px_0_0_#14110d] dark:shadow-[4px_4px_0_0_rgba(255,255,255,0.2)] dark:hover:shadow-[6px_6px_0_0_rgba(255,255,255,0.2)] ${
...
function Toast({ text, kind }: { text: string; kind: "day" | "project" | "week" }) {
  ...
  return (
    <div className={`pointer-events-none fixed inset-x-0 ${position} z-50 flex justify-center px-4 animate-[bounce_0.2s_ease-out]`}>
      <div
        className={`max-w-2xl border-black dark:border-white text-center font-black shadow-[8px_8px_0_0_#14110d] dark:shadow-[8px_8px_0_0_#ffffff] ${size}`}
